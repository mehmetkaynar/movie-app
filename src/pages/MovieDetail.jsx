...
const MovieDetail = () => {
  // herhangi bir filme tiklayinca movie id yi yakaladim useParams ile.
  const { id } = useParams();
          ...
          <div className="p-6 flex flex-col justify-between">
            ...
            <ul className="bg-gray-100 rounded-lg border border-gray-400 text-gray-900">
              ...
              <li className="px-6 py-2 border-gray-400 w-full rounded-t-lg">
                <Link
                  to={-1}
                  className="text-red-600 hover:text-blue-700 transition duration-300 ease-in-out mb-4 underline"
                >
                  Go Back
                </Link>
              </li>
